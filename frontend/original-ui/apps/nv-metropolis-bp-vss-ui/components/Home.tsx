...
const dynamicComponents = {
  NemoAgentToolkitApp: dynamic(
    () =>
      import("@nemo-agent-toolkit/ui")
        .then((mod) => mod.NemoAgentToolkitApp)
        .catch((error) => {
          console.error(
            "[DynamicImport] Failed to load NemoAgentToolkitApp:",
            error
          );
            ...
            return (
              <div className="flex-1 p-6 overflow-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  NemoAgentToolkit component library not available. Please
                  install @nemo-agent-toolkit/ui package.
                </p>
              </div>
            );
          };
  ...
  AlertsComponent: dynamic(
    () =>
      import("@nv-metropolis-bp-vss-ui/all")
        .then((mod) => mod.AlertsComponent)
        .catch((error) => {
          console.error(
            "[DynamicImport] Failed to load AlertsComponent:",
            error
          );
          return function AlertsComponentFallback() {
            return (
              <div className="flex-1 p-6 overflow-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Alerts component library not available. Please install
                  @nv-metropolis-bp-vss-ui/all package.
                </p>
              </div>
            );
          };
  ...
  SearchComponent: dynamic(
    () =>
      import("@nv-metropolis-bp-vss-ui/all")
        ...
        .catch((error) => {
          console.error(
            "[DynamicImport] Failed to load SearchComponent:",
            error
          );
          return function SearchComponentFallback() {
            return (
              <div className="flex-1 p-6 overflow-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Search component library not available. Please install
                  @nv-metropolis-bp-vss-ui/all package.
                </p>
              </div>
            );
  ...
  DashboardComponent: dynamic(
    () =>
      import("@nv-metropolis-bp-vss-ui/all")
        ...
        .catch((error) => {
          console.error(
            "[DynamicImport] Failed to load DashboardComponent:",
            error
          );
          return function DashboardComponentFallback() {
            return (
              <div className="flex-1 p-6 overflow-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Dashboard component library not available. Please install
                  @nv-metropolis-bp-vss-ui/all package.
                </p>
              </div>
            );
          ...
          return function MapComponentFallback() {
            return (
              <div className="flex-1 p-6 overflow-auto">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Map component library not available. Please install
                  @nv-metropolis-bp-vss-ui/all package.
                </p>
              </div>
            );
  ...
  VideoManagementComponent: dynamic(
    () =>
      import("@nv-metropolis-bp-vss-ui/all")
        .then((mod) => mod.VideoManagementComponent)
        .catch((error) => {
          console.error(
            "[DynamicImport] Failed to load VideoManagementComponent:",
            error
          );
...
export default function Home({
  ...
  const [chatControlHandlers, setChatControlHandlers] =
    useState<ChatSidebarControlHandlers | null>(null);
  const [alertsControlHandlers, setAlertsControlHandlers] =
    useState<AlertsSidebarControlHandlers | null>(null);
  const [searchControlHandlers, setSearchControlHandlers] =
    useState<SearchSidebarControlHandlers | null>(null);
  const [dashboardControlHandlers, setDashboardControlHandlers] =
    useState<DashboardSidebarControlHandlers | null>(null);
  const [mapControlHandlers, setMapControlHandlers] =
    useState<MapSidebarControlHandlers | null>(null);
  const [videoManagementControlHandlers, setVideoManagementControlHandlers] =
    useState<VideoManagementSidebarControlHandlers | null>(null);
  ...
  React.useEffect(() => {
    ...
    if (!hasLoadedFromStorage && typeof window !== "undefined") {
      try {
        ...
        console.warn(
          "[Home] Failed to load activeTab from sessionStorage:",
          error
        );
      }
  ...
  React.useEffect(() => {
    if (hasLoadedFromStorage && typeof window !== "undefined") {
      try {
        ...
        console.warn(
          "[Home] Failed to save activeTab to sessionStorage:",
          error
        );
      }
    }
  ...
  const chatControlsReadyCallback = React.useCallback(
    (handlers: ChatSidebarControlHandlers) => {
  ...
  const alertsControlsReadyCallback = React.useCallback(
    (handlers: AlertsSidebarControlHandlers) => {
      ...
      setAlertsControlHandlers((prev: AlertsSidebarControlHandlers | null) => {
        ...
        if (prev && prev.controlsComponent === handlers.controlsComponent)
          return prev;
        return handlers;
      });
    },
  ...
  const searchControlsReadyCallback = React.useCallback(
    (handlers: SearchSidebarControlHandlers) => {
  ...
  const dashboardControlsReadyCallback = React.useCallback(
    (handlers: DashboardSidebarControlHandlers) => {
  ...
  const mapControlsReadyCallback = React.useCallback(
    (handlers: MapSidebarControlHandlers) => {
  ...
  const videoManagementControlsReadyCallback = React.useCallback(
    (handlers: VideoManagementSidebarControlHandlers) => {
  ...
  const renderTabComponent = (tabConfig: TabConfig) => {
      ...
      return (
        ...
        >
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Component &quot;{tabConfig.component}&quot; not found.
            </p>
          </div>
        </div>
      );
        ...
        >
          <div className="h-full w-full [&>main]:!h-full [&>main]:!w-full">
            <DynamicComponent
              ...
              renderApplicationHead={false}
              onControlsReady={
                (isActive ? chatControlsReadyCallback : undefined) as any
              }
            />
          </div>
        </div>
    ...
    if (componentName === "SearchComponent") {
      ...
      componentProps.onControlsReady = isActive
        ? searchControlsReadyCallback
        : undefined;
      componentProps.registerChatAnswerHandler = registerSearchTabChatAnswer;
      componentProps.registerSidebarChatEventSubscriber =
        registerSearchTabSidebarChatEvents;
      ...
      componentProps.renderControlsInLeftSidebar = true;
      componentProps.onControlsReady = isActive
        ? dashboardControlsReadyCallback
        : undefined;
      ...
      componentProps.renderControlsInLeftSidebar = true;
      componentProps.onControlsReady = isActive
        ? videoManagementControlsReadyCallback
        : undefined;
      componentProps.registerChatAnswerHandler =
        registerVideoManagementTabChatAnswer;
      componentProps.registerSidebarChatEventSubscriber =
        registerVideoManagementTabSidebarChatEvents;
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-black">
          ...
          <div className="flex items-center space-x-2 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 p-2 flex-shrink-0 relative">
              ...
              <img
                ...
                alt="NVIDIA Logo"
                className={`h-5 w-auto transition-opacity duration-150 ${
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden">
        ...
        {visibleTabs.length > 0 && (
          <aside
            className={`bg-white dark:bg-neutral-900 border-r border-gray-300 dark:border-gray-600 flex flex-col shrink-0 overflow-hidden transition-all duration-300 ease-in-out ${
              sidebarCollapsed ? "w-0 min-w-0 border-r-0" : ""
            }`}
            style={
              sidebarCollapsed
          ...
          >
            ...
            <nav
              ...
              className="border-b border-gray-300 dark:border-gray-600 flex flex-col flex-shrink-0"
            >
              <div className="px-2 pt-3 pb-2 flex-shrink-0"></div>
