...
VLM_HUMAN_PROMPT_TEMPLATE = (
    ...
    "cannot be seen; never silently omit one. Each labeled line must answer its own category "
    "instead of repeating another line. Explicitly state close versus separated and "
    ...
    "components, PPE, signs, and all distinct on-screen safety text across the sequence; "
    "explain visible tool-to-hose connections. In forklift scenes, inspect every frame for "
    "room, distance, barrier, restricted-area, or pedestrian guidance. "
    ...
    "Spatial and task relationships: explicitly classify the visible relation as near or "
    "close, safe distance or separated, working together or independently, or uncertain. "
    "When a forklift and person are visible, explicitly state whether safe distance or "
    "separation is maintained and cite any visible instruction to give forklifts room.\n"
    "PPE: inspect visible head, eyes, hands, feet, and high-visibility clothing; identify "
    "visible protection, visibly missing protection, or what cannot be assessed.\n"
    "Safety assessment: directly answer the requested risk, accident, or compliance question "
    "and keep the conclusion consistent with all preceding observations.\n\n"
    "User question: {query}"
)
